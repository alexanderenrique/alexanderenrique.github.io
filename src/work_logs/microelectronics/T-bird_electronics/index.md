...
<div class="grid grid--2">
    ...
    <div class="card">
        ...
        <a href="{{ '/microelectronics/engine_sensing_node/' | url }}" class="section__link">View Work Log →</a>
    </div>

    <div class="card">
        <h3 class="card__title">Methanol Injection Controller</h3>
        <p class="card__description">Controller for methanol injection line pressure and spray monitoring. Work log coming soon.</p>
        <a href="{{ '/microelectronics/methanol_injection_controller/' | url }}" class="section__link">View Work Log →</a>
    </div>
</div>
