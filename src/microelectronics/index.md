...
<div class="hero">
    <img src="{{ '/images/wiring-sticker.png' | url }}" alt="Wiring Sticker" style="max-width: 200px; margin: 0 auto var(--spacing-md); display: block;">
    <h1 class="hero__title">Microelectronics Projects</h1>
    <p class="hero__subtitle">Embedded systems, circuit design, and modern technology integration</p>
</div>
